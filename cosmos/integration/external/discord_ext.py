"""
<<<<<<< HEAD:cosmos/integration/external/discord_ext.py
cosmos Discord Bridge - ChatOps Interface.

"Bringing the Professor to the server, one message at a time."

This module enables a full Discord bot interface for cosmos.
"""
...
async def start_discord_bridge(token: str = None) -> DiscordBridge:
    ...
    await bridge.start()
    return bridge
>>>>>>> dd5db7d5307d56ce54f13e61b92f95333530d4d1:farnsworth/integration/external/discord_ext.py
