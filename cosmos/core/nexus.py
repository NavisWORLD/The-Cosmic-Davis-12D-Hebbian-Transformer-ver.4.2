"""
<<<<<<< HEAD:cosmos/core/nexus.py
cosmos Nexus: The Neural Event Bus.

The Nexus is the central nervous system of cosmos v1.3.
=======
Farnsworth Nexus: The Neural Event Bus.

The Nexus is the central nervous system of Farnsworth v1.3.
>>>>>>> dd5db7d5307d56ce54f13e61b92f95333530d4d1:farnsworth/core/nexus.py
...
<<<<<<< HEAD:cosmos/core/nexus.py
# Global accessor
print("DEBUG: nexus.py: Creating Nexus instance...")
nexus = Nexus.get_instance()
print("DEBUG: nexus.py: Nexus instance created")
